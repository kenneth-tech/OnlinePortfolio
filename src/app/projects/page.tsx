...
function ProjectPreview({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-brand-button/15 bg-brand-ink/70 shadow-[0_18px_60px_rgba(0,0,0,0.24)]">
...
export default function ProjectsPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-5 py-14 sm:px-8">
      ...
      <article className="mt-10 grid gap-8 rounded-2xl border border-brand-button/20 bg-brand-card/75 p-5 shadow-[0_24px_90px_rgba(0,0,0,0.26)] lg:grid-cols-[1.15fr_0.85fr] lg:p-6">
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2">
        {projectGrid.map((project) => (
          <article
            key={project.title}
            className="flex flex-col overflow-hidden rounded-xl border border-brand-button/15 bg-brand-card/65 shadow-[0_18px_60px_rgba(0,0,0,0.18)] transition-[border-color,transform,box-shadow] duration-200 hover:-translate-y-1 hover:border-brand-button/45 hover:shadow-[0_18px_70px_rgba(127,255,212,0.10)]"
          >
