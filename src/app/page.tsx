    ...
    <div className="bg-transparent">
      <ScrollReveal as="section" className={`${styles.hero} relative overflow-hidden`}>
        <div className="relative mx-auto grid min-h-[calc(100svh-88px)] w-full max-w-6xl items-center gap-10 px-4 py-12 sm:px-8 sm:py-16 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12 lg:py-24">
          <ScrollReveal
            className="motion-surface text-center sm:text-left"
            direction="left"
          >
          ...
          <ScrollReveal
            as="aside"
            className="motion-card rounded-2xl border border-brand-button/20 bg-brand-card/70 p-4 shadow-[0_24px_90px_rgba(0,0,0,0.28)] backdrop-blur sm:p-6"
            delay={120}
            direction="right"
          >
      ...
      <ScrollReveal as="section" className="mx-auto w-full max-w-6xl border-t border-brand-button/10 px-4 py-10 sm:px-8 sm:py-12">
        <h2 className="text-2xl font-semibold text-white">Highlights</h2>
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {stats.map((stat, index) => (
            <StatCard key={stat.value} {...stat} delay={index * 90} />
          ))}
        </div>
      </ScrollReveal>

      <ScrollReveal as="section" className="mx-auto grid w-full max-w-6xl gap-10 border-t border-brand-button/10 px-4 py-10 sm:px-8 sm:py-12 lg:grid-cols-[1.1fr_0.9fr]">
